...
# Charge les variables d'environnement (utile pour cacher la clé API)
load_dotenv()

# Assurez-vous d'avoir défini votre clé API Google dans un fichier .env
# ou en tant que variable d'environnement système nommée "GOOGLE_API_KEY"
if "GOOGLE_API_KEY" not in os.environ:
    print("ERREUR : La variable d'environnement GOOGLE_API_KEY n'est pas définie.")
    print("Veuillez créer un fichier .env à la racine de votre projet avec le contenu suivant :")
    print("GOOGLE_API_KEY='VOTRE_CLE_API_ICI'")
    exit()

llm = ChatGoogleGenerativeAI(model="gemini-1.5-flash", temperature=0.8, convert_system_message_to_human=True)
print("--- Modèle LLM Google Gemini initialisé ---")

# --- Fonction de nettoyage efficace ---
def clean_llm_output(text: str) -> str:
    ...
    if not isinstance(text, str):
        return ""
    # Remplace le motif <think>...</think> (sur plusieurs lignes) par une chaîne vide
    cleaned_text = re.sub(r'<think>.*?</think>', '', text, flags=re.DOTALL)
    # Supprime les espaces ou nouvelles lignes au début et à la fin
...
scenario_details = {
    "game_system": "Cyberpunk avec le système de jeu Cypher System",
    "player_count": "4 joueurs",
    "theme_tone": "Action, horreur",
    "constraints": "L'un de leur nouveaux alliés sera le véritable méchant",
    "key_elements": "trahison et manipulation",
    "elements_to_avoid": "",
    "core_idea": "Un de leur proche est malade à cause d'une nouvelle drogue mise sur le marché, ils vont enquêter."
}


# --- 2. Définition des Prompts pour les Agents ---

# Agent 0: Le Synthétiseur de Demande
...
# Agent 1: Le Concepteur de scénario
...
# Étape 0: Agent 0 - Création du synopsis narratif
# L'agent prend les détails et crée l'histoire.
...
print("--- [ÉTAPE 0] RÉSULTAT DU SYNOPIS NARRATIF ---")
print(synopsis + "\n" + "-"*50 + "\n")

######################################################################

# Étape 1: Agent 1 - Découpage et structure du scénario jouable
# L'agent prend le synopsis et les détails initiaux pour créer la structure du scénario.
...
print("--- [ÉTAPE 1] RÉSULTAT DU CONCEPTEUR DE SCÉNARIO ---")
print(scenario + "\n" + "-"*50 + "\n")


# Étape 3: Agent 2 - Création des PNJ
# L'agent se base sur le scénario corrigé pour créer les personnages.
...
print("--- [ÉTAPE 3] RÉSULTAT DU CRÉATEUR DE PNJ ---")
print(npcs + "\n" + "-"*50 + "\n")

######################################################################

# Étape 4: Agent 3 - Création des Lieux
# L'agent prend le scénario corrigé, les fiches PNJ, et les détails pour créer les lieux.
...
print("--- [ÉTAPE 4] RÉSULTAT DU CRÉATEUR DE LIEUX ---")
print(locations + "\n" + "-"*50 + "\n")

######################################################################

# Étape 6: Agent 4.2 - Remplissage des scènes
# L'agent final prend toutes les informations pour créer le scénario complet et détaillé.
...
print("--- [ÉTAPE 6] RÉSULTAT DU REMPLISSAGE FINAL DES SCENES ---")
print(scenes_final + "\n" + "-"*50 + "\n")

######################################################################

# Étape 6: Création du titre
# L'agent final prend toutes les informations pour créer le scénario complet et détaillé.
...
print("--- [ÉTAPE 6] GENERATION DU TITRE ---")
print(title + "\n" + "-"*50 + "\n")




# --- Assemblage final en Python ---
print("--- [ÉTAPE 9] ASSEMBLAGE DU DOCUMENT FINAL EN PYTHON... ---\n")
...
print("="*50)
print("SCÉNARIO DE JEU DE RÔLE NARRATIF (MARKDOWN FINAL)")
print("="*50)
print(final_scenario)

# Pour sauvegarder le fichier :
# with open("scenario_narratif_final.md", "w", encoding="utf-8") as f:
